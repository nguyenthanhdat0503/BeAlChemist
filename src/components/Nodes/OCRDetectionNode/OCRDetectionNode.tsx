...
const OCRDetectionNode = ({ data, selected }: Props) => {
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: NODE_TYPES.OCR_DETECTION.BACKGROUND,
      }}
    >
      <CustomHandle
        type="target"
      ...
      <div className="p-4">
        ...
        <div className="mt-2 flex items-end justify-between">
          <strong className="text-white text-xs">OCR Detection</strong>
          <Upload
            type="select"
            multiple={false}
            accept="image/*"
...
export default memo(OCRDetectionNode);
