...
const FeatureDetectionNode = ({ data, selected }: Props) => {
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: NODE_TYPES.FEATURE_DETECTION.BACKGROUND,
      }}
    >
      <CustomHandle
        type="target"
      ...
      <div className="p-4">
        ...
        <strong className="text-white text-xs">Feature Detection</strong>
          <Upload
            type="select"
            multiple={false}
            accept="image/*"
...
export default memo(FeatureDetectionNode);
