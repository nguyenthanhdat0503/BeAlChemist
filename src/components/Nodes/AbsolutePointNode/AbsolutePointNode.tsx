...
const AbsolutePointNode = ({ data, selected }: Props) => {
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: NODE_TYPES.ABSOLUTE_POINT.BACKGROUND,
      }}
    >
      <CustomHandle
        type="target"
      ...
      <div className="p-4">
        ...
        <strong className="text-white text-xs">Absolute Point</strong>
          <Upload
            type="select"
            multiple={false}
            accept="image/*"
...
export default memo(AbsolutePointNode);
