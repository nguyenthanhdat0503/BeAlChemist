...
const GeneralNode = ({ data, selected }: Props) => {
  ...
  const handleImageChange = (info: any) => {
    ...
    if (data?.label === NODE_TYPES.GENERAL.TYPE) {
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: NODE_TYPES.GENERAL.BACKGROUND,
      }}
    >
      <CustomHandle
        type="target"
      ...
      <div className="p-4">
        <Input
          value={label}
          onChange={onChange}
          className="nodrag rounded-none w-[200px] fill-gray-800"
        />
        ...
        <div className="mt-2 flex items-end justify-between">
          <strong className="text-white text-xs">General</strong>
          <Upload
            type="select"
            multiple={false}
            accept="image/*"
