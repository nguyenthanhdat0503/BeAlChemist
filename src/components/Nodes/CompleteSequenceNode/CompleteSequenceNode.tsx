...
import { CheckCircleOutlined, CheckOutlined, UploadOutlined } from "@ant-design/icons";
...
const CompleteSequenceNode = ({ data, selected }: Props) => {
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: NODE_TYPES.COMPLETE_SEQUENCE.BACKGROUND,
      }}
    >
      <CustomHandle
        type="target"
      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex items-end justify-between">
          <strong className="text-white text-xs">Complete</strong>
...
export default memo(CompleteSequenceNode);
