...
const DynamicObjectDetectionNode = ({ data, selected }: Props) => {
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: NODE_TYPES.DYNAMIC_OBJECT_DETECTION.BACKGROUND,
      }}
    >
      <CustomHandle
        type="target"
      ...
      <div className="p-4">
        ...
        <strong className="text-white text-xs">Dynamic Object Detection</strong>
          <Upload
            type="select"
            multiple={false}
            accept="image/*"
...
export default memo(DynamicObjectDetectionNode);
